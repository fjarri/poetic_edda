...
\newfontfamily\stanzafont[Mapping=tex-text]{Optima}
...
\texticelandic{\stanzafont#3}
\end{minipage}

&

\begin{minipage}[t]{0.5\textwidth}
\textenglish{\stanzafont#4}
\end{minipage} 
...
% Debug stubs. Disables cross-references, in order to avoid warnings about not yet existing chapters
\newcommand{\chapterref}[1]{\emph{#1}}
\newcommand{\stanzaref}[2][\@empty]{#2}
...
% title
\title{\fontsize{48pt}{48pt}\selectfont Poetic Edda}
...
\date{}
\publishers{\small{Typeset by Bogdan Opanchuk, \\ compiled on \today}}
