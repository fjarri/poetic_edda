...
\ifcase\isDraft
	...
	\newcommand{\eddaproseref}[3][\@empty]{\ifx\@empty#1\textcolor{red}{#3}\else\textcolor{red}{#1}\fi}
\else
	...
	\newcommand{\eddaproseref}[3][\@empty]{\ifx\@empty\hyperref[cha:#2:#3]{#3}\else\hyperref[cha:#2:#3]{#1}\fi}
\fi
...
\newcommand{\eddacombinedproseref}[3][\@empty]{\eddachapterref{#2,} \eddaproseref[#1]{#2}{#3}}
...
\newcommand{\eddastanzaprelude}[1]{\textit{#1}}
