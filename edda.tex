...
\newcommand{\eddasepline}{
	...
	\vskip\baselineskip
	\nopagebreak
	\centerline{\rule[1ex]{.5\textwidth}{.5pt}}
	\nopagebreak
	\vskip\baselineskip
	\nopagebreak
}
...
% command for inline header
\newcommand{\eddasection}[2]{ % subsection inside Edda chapter
	\addsec*{#1}
	{\large\sffamily #2}
