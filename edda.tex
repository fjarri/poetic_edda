...
\newcommand{\eddanumberfield}[1]{\makebox[2\parindent][l]{\eddastanzanum{#1}}} % stanza number
\newcommand{\eddaleftfield}[1]{\begin{minipage}[t]{0.4\textwidth} \texticelandic{\stanzafont #1} \end{minipage}} % original
\newcommand{\eddarightfield}[1]{\begin{minipage}[t]{0.5\textwidth} \textenglish{\stanzafont #1} \end{minipage}} % translation
