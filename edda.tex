...
\newcommand{\chapterref}[1]{
	\hyperref[cha:#1]{\emph{#1}}
}

\newcommand{\stanzaref}[2][\@empty]{
	\ifx\@empty#1
		\hyperref[\thischapterlabel:#2]{#2}
	\else
		\hyperref[cha:#1:#2]{#2}
	\fi
}

\newcommand{\stanzarangeref}[3][\@empty]{
	\stanzaref[#1]{#2}\ndash\stanzaref[#1]{#3}
}

\newcommand{\combinedref}[2]{
	\chapterref{#1,} \stanzaref[#1]{#2}
}

\newcommand{\combinedrangeref}[3]{
	\chapterref{#1,} \stanzarangeref[#1]{#2}{#3}
}
