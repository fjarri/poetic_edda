...
\newcommand{\stanzalabel}[1]{
	\phantomsection
	\label{\thischapterlabel:#1}
}

\newcommand{\mystanzaprelude}[2]{
	\hskip -\parindent
	\begin{tabular}{@{} p{2\parindent} @{} p{0.4\textwidth} @{} p{0.5\textwidth}}
	&
	{\large\setstretch{1.3}\selectfont\stanzafont \textit{#1}}
	&
	{\large\setstretch{1.3}\selectfont\stanzafont \textit{#2}}
	\end{tabular}
	\nopagebreak
...
\makebox[2\parindent][l]{\displaystanzanum{#2}}

&

\begin{minipage}[t]{0.4\textwidth}
\large\setstretch{1.3}\selectfont\texticelandic{\stanzafont#3}
\end{minipage}

&

\begin{minipage}[t]{0.5\textwidth}
\large\setstretch{1.3}\selectfont\textenglish{\stanzafont#4}
\end{minipage} 
...
\newcommand{\myverse}[1]{
	% different separator here, because we have much more space
	{\renewcommand\sep{\textcolor{gray}{~|~}}
		{\stanzafont
			\begin{verse}
			#1
			\end{verse}
