...
\newcommand{\eddaproseright}[1]{\begin{minipage}[t]{0.5\textwidth} \textenglish{\stanzafont #1} \end{minipage}} % translation
\newcommand{\eddaprosetable}[1]{ % table with paired prose
	...
	\large\setstretch{1} % increased size and additional space between lines, to visually separate stanzas from comments
		\begin{longtable}{@{} p{0.5\textwidth} @{} p{0.49\textwidth}}
		#1
		\end{longtable}
	}
}
