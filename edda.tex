...
\newcommand{\missingword}{\rule[1ex]{5em}{.5pt}}

\newcommand{\asterisks}{\centerline{* \hskip 1.5em \lower .5ex\hbox {*} \hskip 1.5em *}}
...
\newcommand{\eddasection}[2][\@empty]{ % subsection inside Edda chapter
	\addsec*{#2}
	\ifx\@empty#1
	\else
		{\large\sffamily #1}
