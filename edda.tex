...
% main stanza font
\newcommand{\eddastanzatexticelandic}[1]{\large\setstretch{1.3}\selectfont \texticelandic{\stanzafont #1}}
\newcommand{\eddastanzatextenglish}[1]{\large\setstretch{1.3}\selectfont \textenglish{\stanzafont #1}}

% stanza table
\newcommand{\eddastanzatable}[3]{
	\hskip -\parindent
	\begin{tabular}{@{} l @{} p{0.4\textwidth} @{} p{0.5\textwidth}}
		\makebox[2\parindent][l]{#1}
		&
...
\newcommand{\eddastanza}[4][\@empty]{

	{\renewcommand{\sep}{\eddastanzasep}

	% stanza pair
	\eddastanzatable{\eddastanzanum{#2}}
	{
		\eddastanzatexticelandic{#3}
	}
	{
		\eddastanzatextenglish{#4}
	}
	}
...
% stanza pair without prelude
\newcommand{\eddastanzasimple}[4][\@empty]{
	\eddastanzalabel{#2}
	\nopagebreak
	\eddastanza[#1]{#2}{#3}{#4}
}

% stanza pair with prelude
\newcommand{\eddastanzaprelude}[6][\@empty]{
	\eddastanzalabel{#2}
	\nopagebreak

	\eddastanzatable{ }
	{
		\eddastanzatexticelandic{\textit{#5}}
	}
	{
		\eddastanzatextenglish{\textit{#6}}
	}
